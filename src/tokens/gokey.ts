...
const fetcher: SupplyFetcher = async (options = defaultFetcherOptions) => {
  ...
  const treasury = await getAmountInAddresses(blockFrost, GOKEY, [
    ...
    "addr1qyfpy8cqj4w9a7d44kg6hstqp5434f8m00hn4ymkgxgy2u4nskrrn9f56q03kvyt40u3r5vafmtjlh7zgvtlhgxzqjssq5hya9", // GoKey Community & Marketing
    ...
    "addr1q80nv80zgf6067znqwjx6vmtr03crh22tw7azuyt9y40ewps3l9v924kw9pd28erveajf0fsgq2da2n6qtt7adql0xuqstppaq", // GoKey AirDrop
  ]);
