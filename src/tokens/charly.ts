...
const fetcher: SupplyFetcher = async (options = defaultFetcherOptions) => {
  ...
  const treasuryRaw = await getAmountInAddresses(blockFrost, CHARLY, [
    ...
    "addr1qxpeczj2lluh88sa2g3tm0e3fj39c34rlctmvcszjs67g6wjj9djsz0020h68nz3rxknzdh93nryqzhq6h9z0nnzf0rshrectt", // Tosidrop
    ...
    "addr1qy50hxyh5hxvvs07gz24k6nv0lj06a6ulq020mcusrvxgfw9et23qky4u8yuxf3jlzk3rclhw9vlgdc7k9mjwms4zhgsqpanfu", // ADAYield
    ...
    "addr1q8n8lln36aghpc6a8khwmmmccvp8jahuu32jq5wnchnjx8m2cr3agje4kp2e3crjatftkjtuugs3ftpwz8lxugwng8fqzdyl6m", // team_wallet_2
  ]);
