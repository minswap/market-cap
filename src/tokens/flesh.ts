...
const FLESH = "a1ce0414d79b040f986f3bcd187a7563fd26662390dece6b12262b52464c45534820544f4b454e";

const fetcher: SupplyFetcher = async (options = defaultFetcherOptions) => {
  const blockFrost = getBlockFrostInstance(options);
  const total = 420_000_000_000_000_000;
  const treasury_team_and_distributorsRaw = await getAmountInAddresses(blockFrost, FLESH, [
